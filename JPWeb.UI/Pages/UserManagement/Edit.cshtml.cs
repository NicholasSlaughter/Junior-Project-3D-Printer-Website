...
namespace JPWeb.UI.Pages.UserManagement
{
    ...
    public class EditModel : PageModel
    {
        ...
        {
            new ClaimsViewModel { ClaimName = "User", ClaimFriendlyName = "User", IsChecked = false },
            new ClaimsViewModel { ClaimName = "Admin", ClaimFriendlyName = "Administrator", IsChecked = false },
